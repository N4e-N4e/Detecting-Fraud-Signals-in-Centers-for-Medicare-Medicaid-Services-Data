...
UNDERSAMPLE_REGISTRY = {
    ...
    "CLEANSE": CLEANSE(distance='auto', inhomo=True, k_neighbors=20, k_min=40, k_max=45, random_state=42)
}
...
class MLPipeline:
    ...
    def _explain(self, X_train, X_test, output_dir):
        ...
        plt.figure()
        shap.summary_plot(shap_values, X_test_scaled, plot_type="bar", show=False, feature_names=X_test.columns, max_display=10)
